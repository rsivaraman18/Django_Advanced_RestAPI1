...
HERE TOKEN AUTHENTICATION DONE WITH DJANGO FRAMEWORk
1.STREAM PLATFORM
    1A.Only Admin or Staff can Edit,Delete.
       Others can Just View.

2.Watchlist
    2A.Only Admin or Staff can Edit,Delete.
       Others can Just View.

3.Reviews
    3A.Anyone can make 1 review to 1 single Watchlist.
    3B.The reviewer can edit his own review only.
    3C.Admin has power to delete any user review.
    3D.Anyone can view all the reviews.

4.User
    4A.New token generated for new user on registration.
    4B.Any user can delete his token using logout.
    4C.New token can be genearted for already registerd user.

##############################################################
1.Now Delete all the Entries in Database or Make New database and Migrate

2.Create a superuser
    username : siva
    pwd :siva

3.Now Lets check all Urls Created are Working.(Follow Same Flow)
    3A. Excel sheet will provide detail of url and methods.
    1.User Register     --> POST  --> http://127.0.0.1:8000/userprofiles/register/
    2.User Login        --> POST  --> http://127.0.0.1:8000/userprofiles/login/
    3.User Logout       --> POST  --> http://127.0.0.1:8000/userprofiles/logout/

    4.Stream Viewall    --> GET   --> http://127.0.0.1:8000/movieapi/stream/showall_createstream/
    5.Stream Create     --> POST  --> http://127.0.0.1:8000/movieapi/stream/showall_createstream/
    6.Stream Detail     --> GET   --> http://127.0.0.1:8000/movieapi/stream/1/detailview_updatestream/
    7.Stream Update     --> PATCH --> http://127.0.0.1:8000/movieapi/stream/1/detailview_updatestream/
    8.Stream FullUpdate --> PUT   --> http://127.0.0.1:8000/movieapi/stream/1/detailview_updatestream/
    9.Stream Delete     --> DELETE --> http://127.0.0.1:8000/movieapi/stream/1/detailview_updatestream/
    
    10.Watchlist Viewall    --> GET   --> http://127.0.0.1:8000/movieapi/watchlist/showall_createwatchlist/
    11.Watchlist Create     --> POST  --> http://127.0.0.1:8000/movieapi/watchlist/showall_createwatchlist/
    12.Watchlist Detail     --> GET   --> http://127.0.0.1:8000/movieapi/watchlist/1/detailview_updatewatchlist/
    13.Watchlist Update     --> PATCH --> http://127.0.0.1:8000/movieapi/watchlist/3/detailview_updatewatchlist/
    14.Watchlist FullUpdate --> PUT   --> http://127.0.0.1:8000/movieapi/watchlist/3/detailview_updatewatchlist/
    15.Watchlist Delete     --> DELETE--> http://127.0.0.1:8000/movieapi/watchlist/3/detailview_updatewatchlist/

    16.Review Viewall    --> GET   --> http://127.0.0.1:8000/movieapi/movie/showall_reviews/
    17.Review Create     --> POST  --> http://127.0.0.1:8000/movieapi/movie/1/review_create/
    18.Review Detail     --> GET   --> http://127.0.0.1:8000/movieapi/movie/2/review_detail/
    19.Review Update     --> PUT   --> http://127.0.0.1:8000/movieapi/movie/2/review_detail/
